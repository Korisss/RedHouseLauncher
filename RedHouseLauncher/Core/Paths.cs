...
namespace RedHouseLauncher.Core
{
    internal static class Paths
    {
        ...
        internal static string SkyMPSettingsFilePath = Settings.Settings.PathToSkyrim + "Data\\Platform\\Plugins\\skymp5-client-settings.txt";

        internal static string LauncherFilesPath = Settings.Settings.PathToSkyrim + "Launcher_Files\\";

        internal static string SkyrimExePath = Settings.Settings.PathToSkyrim + "skse64_loader.exe";
    }
}
